...
import com.emailapi.dto.OpeningRequest;
...
public class EmailService {
    ...
    private static final String ADMIN_ADDRESS = "kkt09072@naver.com";
    ...
    public MimeMessage createMessageHtml(String email) throws MessagingException, UnsupportedEncodingException {
        ...
        message.setFrom(new InternetAddress("kkt09072@gmail.com", "admin"));    //보내는 사람
        return message;
    }
