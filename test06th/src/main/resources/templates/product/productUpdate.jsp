...
<div class="l-content" style="width:1280px;margin:20px auto;">
    ...
    <form action="${path0}/board/boardUpdate" method="post" style="width:600px;margin:15px auto;"
          onsubmit="return textCheck(this)">
        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
            <div class="form-group">
                <label for="id">Id</label>
                <input type="text" class="form-control bg-secondary text-white" name="name" id="name" value="${board.name}" minlength="4" maxlength="16"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="title" placeholder="Title" minlength="1" maxlength="30" value="${board.title}"
